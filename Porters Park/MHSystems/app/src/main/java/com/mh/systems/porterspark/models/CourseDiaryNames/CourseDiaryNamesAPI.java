...
public class CourseDiaryNamesAPI {
    ...
    @Expose
    private AJsonParamsCourseDiaryNames aJsonParams;
     ...
     * @param aCommand
     */
    public CourseDiaryNamesAPI(String aClientId, String aCommand, AJsonParamsCourseDiaryNames aJsonParams, String aModuleId, String aUserClass) {
     ...
     *     The aJsonParams
     */
    public AJsonParamsCourseDiaryNames getAJsonParams() {
        return aJsonParams;
    }
     ...
     *     The aJsonParams
     */
    public void setAJsonParams(AJsonParamsCourseDiaryNames aJsonParams) {
        this.aJsonParams = aJsonParams;
    }
