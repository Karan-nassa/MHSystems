...
package com.mh.systems.chesterLeStreet.web.models.clubnews;
...
public class ClubNewsAPI {
     ...
     * @param aCommand
     */
    public ClubNewsAPI(String aClientId, String aCommand, AJsonParamsClubNews aJsonParams, String aModuleId) {
