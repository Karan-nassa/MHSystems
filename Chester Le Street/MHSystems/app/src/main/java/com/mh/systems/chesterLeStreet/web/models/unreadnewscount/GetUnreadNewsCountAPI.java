...
package com.mh.systems.chesterLeStreet.web.models.unreadnewscount;
...
public class GetUnreadNewsCountAPI {
     ...
     * @param aCommand
     */
    public GetUnreadNewsCountAPI(String aClientId, String aCommand, AJsonParamsGetUnreadCount aJsonParams, String aModuleId, String aUserClass) {
        super();
     ...
     */
    public void setAJsonParams(AJsonParamsGetUnreadCount aJsonParams) {
        this.aJsonParams = aJsonParams;
    }
