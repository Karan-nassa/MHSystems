package com.mh.systems.chesterLeStreet.utils.libAlphaIndexing;
...
public class CircularContactView extends ViewSwitcher {
    ...
    public CircularContactView(final Context context, final AttributeSet attrs) {
        ...
        if (isInEditMode())
            setTextAndBackgroundColor("", 0xF1F1F0);

        /**
         *  Customize the Text size displaying in OVAL shape by Karan.
         */
