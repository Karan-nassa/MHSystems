...
public class MembersData {
    ...
    public MembersData(ArrayList<com.mh.systems.chesterLeStreet.web.models.MembersList> membersList, com.mh.systems.chesterLeStreet.web.models.Member member) {
