...
import com.mh.systems.chesterLeStreet.web.models.coursenames.CourseNamesData;
import com.mh.systems.chesterLeStreet.ui.adapter.BaseAdapter.CourseDiaryAdapter;
...
import com.mh.systems.chesterLeStreet.web.models.AJsonParamsCourse;
import com.mh.systems.chesterLeStreet.web.models.CourseDiaryAPI;
import com.mh.systems.chesterLeStreet.web.models.CourseDiaryData;
import com.mh.systems.chesterLeStreet.web.models.CourseDiaryDataCopy;
import com.mh.systems.chesterLeStreet.web.models.CourseDiaryItems;
import com.mh.systems.chesterLeStreet.web.models.CourseDiaryItemsCopy;
...
//                 mCalendarInstance.set(Calendar.DATE, Integer.parseInt( strCurrentDate));
     ...
     */
    private void requestCourseService() {
     ...
     */
    private ArrayList<CourseDiaryData> filterCourseDates(ArrayList<CourseDiaryData> arrayListCourseData) {
     ...
     * name of MONTH.
     */
    private void setTitleBar(String strNameOfMonth) {
...
//                        }
     ...
     */
    private void showNoCourseView(boolean hasData) {
        if (hasData) {
            inc_message_view.setVisibility(View.GONE);
        } else {
            inc_message_view.setVisibility(View.VISIBLE);
