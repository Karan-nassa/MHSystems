...
import com.mh.systems.sunningdale.ui.adapter.RecyclerAdapter.TopUpPriceListRecyclerAdapter;
import com.mh.systems.sunningdale.utils.constants.ApplicationGlobal;
import com.mh.systems.sunningdale.web.models.topup.TopUpPriceListResponse;
import com.mh.systems.sunningdale.web.models.topup.TopUpPricesListAPI;
import com.mh.systems.sunningdale.web.models.topup.TopupList;
...
public class TopUpActivity extends BaseActivity {
     ...
     */
    private void requestTopUpPriceListService() {
     ...
     */
    private void showNoTopUpView(boolean hasData) {
        if (hasData) {
            llMainGroup.setVisibility(View.VISIBLE);
