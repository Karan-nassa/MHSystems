...
public class NewCompEventEntryItems {
    ...
    @Expose
    private AJsonParamsConfirmBooking aJsonParams;
     ...
     * @param aCommand
     */
    public NewCompEventEntryItems(String aClientId, String aCommand, AJsonParamsConfirmBooking aJsonParams, String aModuleId, String aUserClass) {
        super();
    ...
    public AJsonParamsConfirmBooking getAJsonParams() {
        return aJsonParams;
    }

    public void setAJsonParams(AJsonParamsConfirmBooking aJsonParams) {
        this.aJsonParams = aJsonParams;
    }
