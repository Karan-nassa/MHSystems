...
import com.mh.systems.sunningdale.ui.adapter.expandableAdapter.CompResultsExpandListAdapter;
...
import com.mh.systems.sunningdale.web.models.Result;
...
public class CompletedDetailActivity extends BaseActivity {
   ...
   /* @Bind(R.id.lvListOfMembers)
    ...
    private void setupExpandableList() {
        ...
        final int sub_item_size = 40;  // 40px
        ...
        elvListOfMembers.getLayoutParams().height = item_size * expListAdapter.getGroupCount();
