...
import com.mh.systems.sandylodge.activites.CourseDiaryWebviewActivity;
...
import com.mh.systems.sandylodge.models.CourseNames.AJsonParamsCourseNames;
import com.mh.systems.sandylodge.models.CourseNames.CourseNamesAPI;
import com.mh.systems.sandylodge.models.CourseNames.CourseNamesResponse;
...
public class DashboardRecyclerAdapter extends RecyclerView.Adapter<DashboardRecyclerAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (dashboardItemsArrayList.get(getAdapterPosition()).getStrTitleOfGrid().equals("Course Diary")) {
                ...
                intent = new Intent(context, CourseDiaryWebviewActivity.class);
               context.startActivity(intent);
                /*if (((DashboardActivity) context).isOnline(context)) {
                    updateCoursesAvailable();
                } else {
     ...
     */
    private void updateCoursesAvailable() {
    ...
    private void updateSuccessResponse(JsonObject jsonObject) {
        ...
        try {
            ...
            if (courseNamesResponse.getMessage().equalsIgnoreCase("Success")) {
               ...
               // if (courseNamesResponse.getData().size() > 0) {
                    intent = new Intent(context, CourseDiaryWebviewActivity.class);
                    context.startActivity(intent);
                //}
