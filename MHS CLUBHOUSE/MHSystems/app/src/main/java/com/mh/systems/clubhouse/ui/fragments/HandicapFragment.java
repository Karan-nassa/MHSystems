...
import com.mh.systems.clubhouse.ui.activites.HCapHistoryActivity;
import com.mh.systems.clubhouse.ui.activites.ShowCertificateWebview;
...
import com.mh.systems.clubhouse.web.models.AJsonParamsHandicap;
import com.mh.systems.clubhouse.web.models.HCapRecords;
import com.mh.systems.clubhouse.web.models.HandicapAPI;
import com.mh.systems.clubhouse.web.models.HandicapData;
import com.mh.systems.clubhouse.web.models.HandicapResultItems;
import com.mh.systems.clubhouse.web.api.WebServiceMethods;
import com.mh.systems.clubhouse.utils.MyMarkerView;
...
public class HandicapFragment extends Fragment implements OnChartValueSelectedListener {
     ...
     * @param size
     */
    private void loadDetailGraphInfo(ArrayList<HCapRecords> hCapRecordses, int size) {
