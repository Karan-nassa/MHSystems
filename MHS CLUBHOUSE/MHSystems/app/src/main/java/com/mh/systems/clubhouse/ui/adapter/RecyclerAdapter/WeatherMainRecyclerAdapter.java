...
import com.mh.systems.clubhouse.ui.activites.WeatherDetailActivity;
import com.mh.systems.clubhouse.web.models.forecast.ListOfDay;
...
public class WeatherMainRecyclerAdapter extends RecyclerView.Adapter<WeatherMainRecyclerAdapter.ViewHolder> {
    ...
    @Override
    public WeatherMainRecyclerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(WeatherMainRecyclerAdapter.ViewHolder holder, int position) {
