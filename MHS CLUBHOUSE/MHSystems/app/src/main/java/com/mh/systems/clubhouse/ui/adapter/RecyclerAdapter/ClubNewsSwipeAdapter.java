...
import com.mh.systems.clubhouse.ui.activites.ClubNewsActivity;
import com.mh.systems.clubhouse.ui.activites.ClubNewsDetailActivity;
    ...
    public void onBindViewHolder(final SimpleViewHolder viewHolder, final int position) {
        ...
        if (clubNewsDataArrayList.get(position).getMessage().length() > 0) {
            Picasso.with(mContext)
                    .load(WebAPI.API_BASE_URL + clubNewsDataArrayList.get(position).getMessage())
