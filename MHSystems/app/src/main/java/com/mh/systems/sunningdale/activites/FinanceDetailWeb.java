...
public class FinanceDetailWeb extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        strURL = "http://staging.mhsystems.co.uk:8090/ClubTransDetail?aClientId=" + loadPreferenceValue(ApplicationGlobal.KEY_CLUB_ID, "44118078") +"&aCommand=GetAccReceipt&aJsonParams={%22MemberId%22:"+iMemberId+",%22TranId%22:"+iTransactionId+",%22IsTopup%22:"+IsTopup+"}&aModuleId="+ApplicationGlobal.TAG_GCLUB_WEBSERVICES;
