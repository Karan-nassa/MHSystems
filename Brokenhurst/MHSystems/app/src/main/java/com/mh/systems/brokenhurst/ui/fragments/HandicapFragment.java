...
import com.mh.systems.brokenhurst.ui.activites.HCapHistoryActivity;
import com.mh.systems.brokenhurst.ui.activites.MembersActivity;
import com.mh.systems.brokenhurst.ui.activites.ShowCertificateWebview;
...
import com.mh.systems.brokenhurst.web.models.AJsonParamsHandicap;
import com.mh.systems.brokenhurst.web.models.HCapRecords;
import com.mh.systems.brokenhurst.web.models.HandicapAPI;
import com.mh.systems.brokenhurst.web.models.HandicapData;
import com.mh.systems.brokenhurst.web.models.HandicapResultItems;
import com.mh.systems.brokenhurst.web.api.WebServiceMethods;
import com.mh.systems.brokenhurst.utils.MyMarkerView;
...
//        mv.refreshContent(e, h);
    ...
    private void updateSuccessResponse(JsonObject jsonObject) {
        ...
        try {
            ...
            ((MembersActivity) getActivity()).reportRollBarException(HandicapFragment.class.getSimpleName(), e.toString());
            ((BaseActivity) getActivity()).hideProgress();
        }
    }
