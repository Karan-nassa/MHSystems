...
/**
 * The {@link FriendsBookingFragment} used to display the Member list
 ...
 * @since 12 May, 2016
 */
public class FriendsBookingFragment extends Fragment {
    /*********************************
     * INSTANCES OF LOCAL DATA TYPE
     *******************************/
    public static final String LOG_TAG = FriendsBookingFragment.class.getSimpleName();
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser) {
            ...
            ((MembersBookingActivity) getActivity()).setFragmentInstance(new FriendsBookingFragment());
...
//    }
    ...
    public void callWebService() {
        ...
        if (((BaseActivity) getActivity()).isOnline(getActivity())) {
            ((MembersBookingActivity) getActivity()).updateNoInternetUI(true);
           // MemberDetailActivity.isRefreshData = false;
            //Method to hit Members list API.
            requestFriendService();
        } else {
            ((MembersBookingActivity) getActivity()).updateNoInternetUI(false);
        }
    }
    ...
    public void requestFriendService() {
        ...
        aJsonParamsFriends.setMemberId(((MembersBookingActivity) getActivity()).loadPreferenceValue(ApplicationGlobal.KEY_MEMBERID, "10784"));

        friendsAPI = new FriendsAPI(getClientId(), "GETLINKSTOMEMBERS", aJsonParamsFriends, ApplicationGlobal.TAG_GCLUB_WEBSERVICES, ApplicationGlobal.TAG_GCLUB_MEMBERS);
    ...
    public String getClientId() {
        return ((MembersBookingActivity) getActivity()).loadPreferenceValue(ApplicationGlobal.KEY_CLUB_ID, ApplicationGlobal.TAG_CLIENT_ID);
    }
        ...
        try {
            ...
            if (friendsItems.getMessage().equalsIgnoreCase("Success")) {
                ...
                if (friendsDataArrayList.size() == 0) {
                    ((MembersBookingActivity) getActivity()).updateNoDataUI(false);
                    //((BaseActivity) getActivity()).showAlertMessage(getResources().getString(R.string.error_no_data));
                } else {
                    ((MembersBookingActivity) getActivity()).updateNoDataUI(true);
...
//            }
                ...
                rootView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        ((MembersBookingActivity)getActivity()).passMemberName(contact.getNameRecord().getFullName());
                    }
                });
            }
            return rootView;
