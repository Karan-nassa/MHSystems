...
public class FriendContactDetails {
    ...
    @Expose
    private com.mh.systems.demoapp.web.models.Address Address;
     ...
     * @return The Address
     */
    public com.mh.systems.demoapp.web.models.Address getAddress() {
        return Address;
    }
     ...
     */
    public void setAddress(com.mh.systems.demoapp.web.models.Address Address) {
