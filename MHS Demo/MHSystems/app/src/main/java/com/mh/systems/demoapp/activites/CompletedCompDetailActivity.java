...
public class CompletedCompDetailActivity extends BaseActivity {

    private final String LOG_TAG = CompletedCompDetailActivity.class.getSimpleName();
    ...
    private View.OnClickListener mJoinOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if (iPopItemPos == 1 && IsMemberJoined) {
                AlertDialog.Builder builder = new AlertDialog.Builder(CompletedCompDetailActivity.this);
                ...
                if (!IsMemberJoined) {
                    ...
                    startActivity(new Intent(CompletedCompDetailActivity.this, CompetitionEntryActivity.class));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_completed_competition);
     ...
     * {@link CompletedCompDetailActivity}.
     */
        ...
        try {
            ...
            if (competitionDetailItems.getMessage().equalsIgnoreCase("Success")) {
                ...
                if (resultEntryArrayList.size() > 0) {
                    ...
                    competitionDetailAdapter = new CompetitionDetailAdapter(CompletedCompDetailActivity.this, resultEntryArrayList);
