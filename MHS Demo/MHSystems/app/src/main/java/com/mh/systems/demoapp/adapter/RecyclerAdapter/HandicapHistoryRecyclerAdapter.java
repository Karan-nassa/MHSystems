 ...
 * data.
 */
public class HandicapHistoryRecyclerAdapter extends RecyclerView.Adapter<HandicapHistoryRecyclerAdapter.ViewHolder> {
    ...
    public HandicapHistoryRecyclerAdapter(Context context /*ArrayList<CourseDiaryData> CourseDiaryData*/) {
    ...
    @Override
    public HandicapHistoryRecyclerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(HandicapHistoryRecyclerAdapter.ViewHolder holder, int position) {
