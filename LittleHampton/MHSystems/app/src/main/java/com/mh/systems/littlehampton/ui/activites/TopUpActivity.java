...
import com.mh.systems.littlehampton.ui.adapter.RecyclerAdapter.TopUpPriceListRecyclerAdapter;
import com.mh.systems.littlehampton.utils.constants.ApplicationGlobal;
import com.mh.systems.littlehampton.web.models.topup.TopUpPriceListResponse;
import com.mh.systems.littlehampton.web.models.topup.TopUpPricesListAPI;
import com.mh.systems.littlehampton.web.models.topup.TopupList;
...
public class TopUpActivity extends BaseActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        /**
         * If PAYMENT status SUCCESS then navigate user to {@link com.mh.systems.littlehampton.fragments.FinanceFragment}
        ...
        if (resultCode == ACTION_MAKE_PAYMENT) {
            try {
                ...
                reportRollBarException(TopUpActivity.class.getSimpleName(), exp.toString());
            }
        }
    }
