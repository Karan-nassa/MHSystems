package com.mh.systems.littlehampton.utils.constants;
...
public class ApplicationGlobal {
     ...
     * {@link com.mh.systems.littlehampton.fragments.MembersTabFragment} for update MEMBERS list accordingly.
     */
    ...
    /**
     * Used during tap on SPINNER/DROPDOWN selectable items to sent on
     * {@link com.mh.systems.littlehampton.fragments.MembersTabFragment} for update FRIENDS list accordingly.
     */
    ...
    public static String TAG_CLIENT_ID = "44120014";

    /**
     * SHARED PREFERENCE KEY COLLECTION.
     */
    public static final String SHARED_PREF = "MHSPrefs_littlehampton";
