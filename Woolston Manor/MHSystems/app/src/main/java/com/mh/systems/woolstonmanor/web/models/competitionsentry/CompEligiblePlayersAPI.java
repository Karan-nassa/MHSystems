...
package com.mh.systems.woolstonmanor.web.models.competitionsentry;

import com.google.gson.annotations.Expose;
import com.google.gson.annotations.SerializedName;


public class CompEligiblePlayersAPI {
    ...
    @Expose
    private AJsonParamsEligiblePlayers aJsonParams;
     ...
     * @param aCommand
     */
    public CompEligiblePlayersAPI(String aClientId, String aCommand, AJsonParamsEligiblePlayers aJsonParams, String aModuleId, String aUserClass) {
     ...
     *     The aJsonParams
     */
    public AJsonParamsEligiblePlayers getAJsonParams() {
        return aJsonParams;
    }
     ...
     *     The aJsonParams
     */
    public void setAJsonParams(AJsonParamsEligiblePlayers aJsonParams) {
        this.aJsonParams = aJsonParams;
    }
