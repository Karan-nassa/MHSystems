...
public class GetClubEventAPI {
    ...
    @Expose
    private AJsonParamsGetClubEvent aJsonParams;
     ...
     * @param aCommand
     */
    public GetClubEventAPI(String aClientId, String aCommand, AJsonParamsGetClubEvent aJsonParams, String aModuleId, String aUserClass) {
     ...
     *     The aJsonParams
     */
    public AJsonParamsGetClubEvent getAJsonParams() {
        return aJsonParams;
    }
     ...
     *     The aJsonParams
     */
    public void setAJsonParams(AJsonParamsGetClubEvent aJsonParams) {
        this.aJsonParams = aJsonParams;
    }
