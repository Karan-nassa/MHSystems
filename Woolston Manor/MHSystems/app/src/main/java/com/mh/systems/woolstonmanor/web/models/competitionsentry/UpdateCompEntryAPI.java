...
public class UpdateCompEntryAPI {
    ...
    @Expose
    private AJsonParamsUpdateEntry aJsonParams;
     ...
     * @param aCommand
     */
    public UpdateCompEntryAPI(String aClientId, String aCommand, AJsonParamsUpdateEntry aJsonParams, String aModuleId, String aUserClass) {
     ...
     *     The aJsonParams
     */
    public AJsonParamsUpdateEntry getAJsonParams() {
        return aJsonParams;
    }
     ...
     *     The aJsonParams
     */
    public void setAJsonParams(AJsonParamsUpdateEntry aJsonParams) {
        this.aJsonParams = aJsonParams;
    }
