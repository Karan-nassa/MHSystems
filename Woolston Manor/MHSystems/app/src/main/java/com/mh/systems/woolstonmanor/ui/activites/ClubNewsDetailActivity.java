...
import com.mh.systems.woolstonmanor.web.models.clubnewsthumbnail.AJsonParamsClubNewsDetailThumbnail;
...
import com.mh.systems.woolstonmanor.web.models.clubnewsthumbnail.ClubNewsThumbnailDetailResponse;
...
public class ClubNewsDetailActivity extends BaseActivity {
   ...
   /* @Bind(R.id.tvDescOfNews)
     ...
     */
    private void showAlertOk(String strMessage) {
