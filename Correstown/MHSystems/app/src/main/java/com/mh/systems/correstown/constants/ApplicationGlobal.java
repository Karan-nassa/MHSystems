package com.mh.systems.correstown.constants;
...
public class ApplicationGlobal {
     ...
     */
    public static final String KEY_ROLLBAR_CLIENT_PRODUCTION = "83085d94b5ba48dca097989668582cde";
     ...
     * {@link com.mh.systems.correstown.fragments.MembersTabFragment} for update MEMBERS list accordingly.
     */
    ...
    /**
     * Used during tap on SPINNER/DROPDOWN selectable items to sent on
     * {@link com.mh.systems.correstown.fragments.MembersTabFragment} for update FRIENDS list accordingly.
     */
    ...
    public static String TAG_CLIENT_ID = "44028007";

    /**
     * SHARED PREFERENCE KEY COLLECTION.
     */
    public static final String SHARED_PREF = "MHSPrefs_Correstown";
