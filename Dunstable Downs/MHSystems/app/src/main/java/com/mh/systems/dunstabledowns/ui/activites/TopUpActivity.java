...
import com.mh.systems.dunstabledowns.ui.adapter.RecyclerAdapter.TopUpPriceListRecyclerAdapter;
import com.mh.systems.dunstabledowns.utils.constants.ApplicationGlobal;
import com.mh.systems.dunstabledowns.web.models.topup.TopUpPriceListResponse;
import com.mh.systems.dunstabledowns.web.models.topup.TopUpPricesListAPI;
import com.mh.systems.dunstabledowns.web.models.topup.TopupList;
...
public class TopUpActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (strClosingBalance.length() > 0) {
            tvYourBalance.setText((getString(R.string.text_title_your_balance)
                    + " " + /*decimalFormat.format(*/strClosingBalance/*)*/));
   ...
   /* @Override
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        /**
         * If PAYMENT status SUCCESS then navigate user to {@link FinanceFragment}
     ...
     */
    public TextView.OnEditorActionListener mInputActionListener = new TextView.OnEditorActionListener() {
        @Override
     ...
     * for Top Up balance.
     */
    public View.OnClickListener mMakePaymentListener = new View.OnClickListener() {
        @Override
    ...
    public TextWatcher mPrizeChangeListener = new TextWatcher() {
        @Override
