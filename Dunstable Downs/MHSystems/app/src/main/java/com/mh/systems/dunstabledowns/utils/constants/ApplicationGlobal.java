package com.mh.systems.dunstabledowns.utils.constants;
...
public class ApplicationGlobal {
    ...
    public static String TAG_CLIENT_ID = "44008009";

    /**
     * SHARED PREFERENCE KEY COLLECTION.
     */
    public static final String SHARED_PREF = "MHSPrefs_dunstabledowns";
